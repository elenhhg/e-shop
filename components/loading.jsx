    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[#988675]"
        >
          <div className="flex space-x-2 relative">
            {letters.map((letter, index) => (
              <motion.span
                ...
                className="font-serif text-6xl sm:text-8xl text-[#5a5756] tracking-widest"
              >
                {letter}
              </motion.span>
            ))}
          ...
          <motion.div
            ...
            className="mt-6 h-1 w-40 bg-[#5a5756] origin-left rounded-full"
          />
        </motion.div>
      )}
    </AnimatePresence>
